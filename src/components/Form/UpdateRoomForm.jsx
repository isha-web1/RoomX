  ...
  return (
    <div className='w-full min-h-[calc(100vh-40px)] flex flex-col justify-center items-center text-gray-800 rounded-xl bg-gray-50'>
      <form onSubmit={handleSubmit}>
              ...
              <div className='flex flex-col w-max mx-auto text-center'>
                <label>
                  <input
                    ...
                    hidden
                  />
                  <div className='bg-cyan-700 text-white border border-gray-300 rounded font-semibold cursor-pointer p-1 px-3 hover:bg-cyan-500'>
                    Upload Image
                  </div>
                </label>
              </div>
        ...
        <button
          type='submit'
          className='w-full p-3 mt-5 text-center font-medium text-white transition duration-200 rounded shadow-md bg-cyan-700'
        >
          Update
        </button>
      </form>
